...
//title screen
TopDownGame.GameLevel0 = function(){};

var counter = 0;
TopDownGame.GameLevel0.prototype = {
  ...
  create: function() {
    ...
    */
    ...
    this.tutorialAim = this.game.add.text(this.game.world.centerX,1100,
        'Click in this spawn area to create a virus...', tutorialStyle);
    this.tutorialAim.anchor.setTo(0.5);
  ...
  update: function() {
    ...
    if(this.game.input.activePointer.isDown && this.mouseDown == false){
      ...
      if(this.targeting && gameY < 1000){
        this.tutorialShoot.visible = false;
        if(this.tutorialLib.firstTime){
            this.tutorialLib.visible = true;
            this.tutorialLib.firstTime = false;
        }
        this.targetArrow.visible = false;
        ...
        this.tutorialAim.visible = false;
        if(this.tutorialShoot.firstTime){
            this.tutorialShoot.visible = true;
            this.tutorialShoot.firstTime = false;
        }
